...
### 2026-05-15 (凌晨) — 养树激励系统 + UI 极简化

- 集成 js-growing-tree (MIT, Canvas, 4.5KB)
- 仪表盘顶部 Canvas 实时生长的树：学习进度 0%→幼苗, 100%→参天大树
- 追踪中断/完成率<50% → 树立刻枯萎变灰
- 树统计：本周成活 X 棵 / 枯萎 Y 棵
- UI 极简化：移除所有无意义 emoji 图标
- CSS 从 355 行精简到 130 行（gradient/阴影/动画冗余）
- 导航从 9 项精简到 6 项（今日/周报/日历/计划/App/设置）
- 目标追踪融入仪表盘，不再独立页面
- 回归测试：14/14 全部通过
